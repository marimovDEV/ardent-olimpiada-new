...
const AdminOlympiadsPage = lazy(() => import("./pages/admin/AdminOlympiadsPage"));
const AdminOlympiadWizard = lazy(() => import("./pages/admin/olympiad-wizard/AdminOlympiadWizard"));
const AdminOlympiadParticipantsPage = lazy(() => import("./pages/admin/AdminOlympiadParticipantsPage"));
const AdminOlympiadResultsPage = lazy(() => import("./pages/admin/AdminOlympiadResultsPage"));
const AdminProfessionsPage = lazy(() => import("./pages/admin/AdminProfessionsPage"));
const AdminFinancePage = lazy(() => import("./pages/admin/AdminFinancePage"));
const AdminSupportPage = lazy(() => import("./pages/admin/AdminSupportPage"));
const AdminCertificatesPage = lazy(() => import("./pages/admin/AdminCertificatesPage"));
const AdminSettingsPage = lazy(() => import("./pages/admin/AdminSettingsPage"));
const AdminBotPage = lazy(() => import("./pages/admin/AdminBotPage"));
const AdminHomeCMSPage = lazy(() => import("./pages/admin/AdminHomeCMSPage"));
const AdminNotificationsPage = lazy(() => import("./pages/admin/AdminNotificationsPage"));
const AdminAIAssistantPage = lazy(() => import("./pages/admin/AdminAIAssistantPage"));
const AdminParticipantAnalysisPage = lazy(() => import("./pages/admin/AdminParticipantAnalysisPage"));
